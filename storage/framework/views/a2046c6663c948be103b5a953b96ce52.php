...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('createProduct')); ?>" method="POST" enctype="multipart/form-data">
      ...
      <input id="ProductName" type="text" name="ProductName" value="<?php echo e(old("ProductName")); ?>"><br>
...
unset($__errorArgs, $__bag); ?>
      ...
      <input id="ProductPrice" type="text" name="ProductPrice" value="<?php echo e(old("ProductPrice")); ?>"><br>
...
unset($__errorArgs, $__bag); ?>
    ...
    <label for="ProductImage">Company Image</label><br>
      <input id="ProductImage" type="file" name="ProductImage" value="<?php echo e(old("ProductImage")); ?>"><br>
...
</html><?php /**PATH C:\Users\ethan\OneDrive\Documents\tpm36\belajar\resources\views\createProduct.blade.php ENDPATH**/ ?>